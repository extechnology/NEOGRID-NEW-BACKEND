...
class Product(models.Model):
    ...
    shipping_charge = models.DecimalField(max_digits=10, decimal_places=2, default=800, blank=True, null=True)

    warranty = models.CharField(max_length=100, null=True, blank=True, help_text = "eg: 1 year, 6 month  (full small letters)")
