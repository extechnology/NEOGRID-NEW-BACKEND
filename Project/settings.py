...
SECRET_KEY = 'django-insecure-bw-*-q%9i5$&v*#wno&@x)fg5imt_8ah1$ipwq@sgz+)9$wowc'
...
CSRF_TRUSTED_ORIGINS = [
    ...
    "http://localhost:8000",
    "http://127.0.0.1:8000",
    "https://f0tz30h9-8001.inc1.devtunnels.ms",
    "https://server.neogrid.in",
    "https://www.server.neogrid.in",
    "http://server.neogrid.in",
    "http://www.server.neogrid.in",
    "https://www.neogrid.in",
    "https://neogrid.in",
    "http://www.neogrid.in",
    "http://neogrid.in",
]
...
AUTHENTICATION_BACKENDS = [
    'Application.AuthenticationServices.auth_backend.UsernameEmailPhoneBackend',
